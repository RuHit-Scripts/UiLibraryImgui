...
local ui_options = {
	...
	can_resize = true,
	mobile_toggle_button = true, -- Включает плавающую кнопку открытия/закрытия для мобильных устройств
}
...
-- Универсальное получение позиции касания или мыши
		...
		function window_data:AddTab(tab_name)
			...
			do -- Tab Elements
				...
				function tab_data:AddSlider(slider_text, callback, slider_options)
					...
					-- Slider Dragging Logic (Touch + PC Mouse)
